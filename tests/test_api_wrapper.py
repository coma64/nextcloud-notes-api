...
def test_notes_api_get_api_version_requests_mock(notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.get(
...
def test_notes_api_get_all_notes(random_note_seq: Iterator[Note], notes_api_no_etag_caching: NotesApi, requests_mock: RequestsMocker):
...
@pytest.mark.parametrize('random_note_seq', [4, 1, 0], indirect=['random_note_seq'])
def test_notes_api_get_all_notes_etag_cache(random_note_seq: Iterator[Note], notes_api: NotesApi, requests_mock: RequestsMocker):
    random_note_list = list(random_note_seq)
...
@pytest.mark.parametrize('status_code, expectation', [
    (401, pytest.raises(InvalidNextcloudCredentials))
])
def test_notes_api_get_all_notes_response_status_exceptions(status_code: int, expectation: ContextManager, notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.get(
        f'https://{notes_api.hostname}/index.php/apps/notes/api/v1/notes',
...
def test_notes_api_get_single_note(random_note: Note, notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.get(
...
def test_notes_api_get_single_note_response_status_exceptions(status_code: int, expectation: ContextManager, notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.get(
        f'https://{notes_api.hostname}/index.php/apps/notes/api/v1/notes/1337',
        status_code=status_code
    )
...
def test_notes_api_create_note(random_note: Note, notes_api: NotesApi, requests_mock: RequestsMocker):
    # Server sets this
    random_note.id = None
...
def test_notes_api_create_note_response_status_exceptions(status_code: int, expectation: ContextManager, notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.post(
        f'https://{notes_api.hostname}/index.php/apps/notes/api/v1/notes',
        status_code=status_code
    )
...
def test_notes_api_update_note(random_note: Note, notes_api: NotesApi, requests_mock: RequestsMocker):
    random_note.id = 1337
...
def test_notes_api_update_note_response_status_exceptions(status_code: int, expectation: ContextManager, random_note: Note, notes_api: NotesApi, requests_mock: RequestsMocker):
    random_note.id = 1337
...
def test_notes_api_delete_note_response_status_exceptions(status_code: int, expectation: ContextManager, notes_api: NotesApi, requests_mock: RequestsMocker):
    requests_mock.delete(
        f'https://{notes_api.hostname}/index.php/apps/notes/api/v1/notes/1337',
        status_code=status_code
    )
